        ...
        <>
            {width >= 850 ? (
                <div className="relative ml-12 pb-16 grid before:absolute before:left-[-35px] before:block before:h-full before:content-[''] md:grid-cols-5 md:gap-10 md:space-x-4]">
                    ...
                    <div className="relative flex flex-col gap-2 pb-4 text-text text-[17px]/[21px] md:col-span-3">
                        {item.description}
                    </div>
                </div>
            ) : (
                <div>
                    ...
                    <div className="flex justify-center">
                        <div className=" bg-mantle p-5 sm:p-6 md:p-8 rounded-2xl">
                            <p className="uppercase text-[19px]/[18px] xss:text-[20px]/[20px] xs:text-[22px]/[22px] sm:text-[24px] md:text-[30px] font-bold text-text text-center text-pretty">
                                {item.job}
                            </p>
                            <p className="text-[14px] xss:text-[16px] xs:text-[17px] sm:text-[19px] md:text-[25px] font-medium text-subtext1 mb-2 md:mb-4 text-center">
                                {item.company}
                            </p>
                            <p className="text-[13px] xss:text-[13px] xs:text-[14px] sm:text-[15px] md:text-[17px] lg:text-[20px] text-subtext1 text-pretty text-center">
                                {item.description}
                            </p>
                        </div>
                    </div>
