        ...
        <div className="flex justify-center">
            <div className="w-full bg-mantle p-5 sm:p-8 md:p-4 lg:p-3 rounded-2xl">
                ...
                <div className="flex flex-col items-center text-center">
                    <h1 className="text-[19px] xss:text-[20px]  xs:text-[22px] sm:text-[24px] md:text-[30px] font-bold text-text mt-6 mb-1 uppercase">
                        {title}
                    </h1>
                    <ProjectCardTags tags={tags} />
                    <p className="mt-5 text-[13px] xss:text-[14px] xs:text-[14px] sm:text-[17px] md:text-[17px] lg:text-[17px] text-subtext1">
                        {description}
                    </p>
