    ...
    return (
        <div className="flex justify-center lg:justify-normal col-span-2">
            <button
                ...
                type="button"
                className="w-[90%] lg:w-full text-base hover:scale-105 transition duration-150 flex items-center justify-center font-display text-xl font-bold rounded-xl h-10  xs:h-12 bg-gradient-to-tr from-blue via-mauve to-pink"
            >
